...
public class WarrantixAboutFragment3 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_about3, container, false);

        tutorial3 = (ImageView) v.findViewById(R.id.tutorial3);
    ...
    public void animStart() {
        if (tutorial3 != null) {
            AnimationDrawable drawable = (AnimationDrawable) tutorial3.getBackground();
    ...
    private AnimationSet createMoveAnimation(final View targetView, int delay) {
        ...
        tutorial3.getLocationOnScreen(centerPos);
        centerPos[0] += tutorial3.getWidth()/2;
        centerPos[1] += tutorial3.getHeight()/2;
