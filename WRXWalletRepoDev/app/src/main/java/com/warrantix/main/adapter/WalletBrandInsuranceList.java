...
public class WalletBrandInsuranceList extends BaseAdapter {

    private final Activity context;
    private List<ServiceCompany> mServiceCompanies = new ArrayList<>();

    public WalletBrandInsuranceList(Activity context, List<ServiceCompany> serviceCompanies) {
        ...
        shopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (context instanceof BaseActivity) {
                    Intent i = new Intent(context, WalletBrandInsurance.class);
