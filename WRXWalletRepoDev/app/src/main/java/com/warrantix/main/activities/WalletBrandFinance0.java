 ...
 */
public class WalletBrandFinance0 extends BaseActivity {
    private ListView list = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_brand_finance0);
    }
    ...
    public void InitializeView(){
        ...
        WalletBrandFinanceList adapter = new WalletBrandFinanceList(this, name, place, imageID);
