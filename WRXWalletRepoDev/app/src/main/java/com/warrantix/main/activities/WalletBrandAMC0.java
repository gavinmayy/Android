...
public class WalletBrandAMC0 extends BaseActivity {
    ...
    public void InitializeView(){
        ...
        GetServiceCompaniesResponse getServiceCompaniesResponse = BackendManager.getInstance().getServiceCompaniesResponse(WarrantixPreference.TYPE_AMC, WarrantixPreference.BRANDID_HEROID);
        if (getServiceCompaniesResponse != null){
            ...
            if (serviceCompanies.size() != 0) {
                WalletBrandAMCList adapter = new WalletBrandAMCList(this, serviceCompanies);
