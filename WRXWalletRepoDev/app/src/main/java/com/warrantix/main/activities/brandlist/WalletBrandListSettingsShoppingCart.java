...
public class WalletBrandListSettingsShoppingCart extends BaseActivity {
    ...
    public void Initialize(){
        ...
        String[] name2 = { "Hero MotoCorp", "Hero MotoCorp", "Hero MotoCorp","Hero MotoCorp", "Hero MotoCorp", "Hero MotoCorp","Hero MotoCorp", "Hero MotoCorp", "Hero MotoCorp","Hero MotoCorp"};
