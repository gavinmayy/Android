...
import com.warrantix.main.adapter.WarrantixMarketplaceInsuranceAdapter;
...
public class WalletMarketplaceInsurance extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marketplace_insurance);
    }
    ...
    public void initialize() {
        ...
        WarrantixMarketplaceInsuranceAdapter adapter = new WarrantixMarketplaceInsuranceAdapter(this, name,name0, name1, days,imageID);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent mIntent = new Intent(WalletMarketplaceInsurance.this, WalletBrandProductsDetail.class);
        ...
        public void onScrollStateChanged(AbsListView view, int scrollState) {
            ...
            if (mIsScrollingUp == true) {
                if (mCategory.getVisibility() != View.VISIBLE) {
                    ...
                    Animation animation = AnimationUtils.loadAnimation(WalletMarketplaceInsurance.this, R.anim.animation_slide_in_up);
                ...
                if (mCategory.getVisibility() != View.GONE) {
                    ...
                    Animation animation = AnimationUtils.loadAnimation(WalletMarketplaceInsurance.this, R.anim.animation_slide_out_up);
                    animation.setDuration(400);
                    mCategory.setAnimation(animation);
                    mCategory.animate();
                    animation.start();
