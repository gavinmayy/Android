...
public class WalletBrandSocialRankList extends ArrayAdapter<String> {

    private final Activity context;
    private final String[] name,place,days;
    private final String[] imageId;

    public WalletBrandSocialRankList(Activity context, String[] name, String[] place, String[] days, String[] imageId) {
        super(context, R.layout.listview_wallet_brand_social_rank, name);
