    ...
    public void Initialize(){
        ...
        listHours.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (itemPosition){
                    case 0 : interval = 3*3600*second; break;
                    case 1 : interval = 2*3600*second; break;
                    case 2 : interval = 1*3600*second; break;
                    case 3 : interval = 30*60*second;  break;
                    case 4 : interval = 15*60*second;  break;
                    case 5 : interval = 10*60*second;  break;
                }
