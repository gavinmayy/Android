...
public class WalletBrandSocialReferFragment extends BaseFragment {
    ...
    public void InitializeView(){
        ...
        address.add("via email ");
        address.add("via facebook");
        address.add("via facebook");
        address.add("via email");
...
//        String[] name = { "Srinivasan M.K", "Ajay Patel", "Rahul Kumar" ,"Srinivasan M.K"};
//        String[] address = { "via eamil ", "via facebook", "via facebook","via eamil  " };
//        String[] days = {"1 days","12/15/2015","18/11/2015","1 days"};
//        String[] explain = {"","","",""};
//        String[] imageID = { "person1","person2", "person3", "person1"};
