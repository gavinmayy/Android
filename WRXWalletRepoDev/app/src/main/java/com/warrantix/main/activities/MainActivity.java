...
import com.warrantix.main.dialog.CustomerRegistrationDialog;
...
//        boolean bFromPlugin = getIntent().getBooleanExtra("fromPlugin", false);
//        if (bFromPlugin == true) {
...
//        }
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(intent.getAction().equals(WarrantixRegIntentService.REGISTRATION_SUCCESS)){
                ...
                } else if(intent.getAction().equals(WarrantixRegIntentService.REGISTRATION_ERROR)){
        ...
        if(ConnectionResult.SUCCESS != resultCode) {
            ...
            Intent itent = new Intent(this, WarrantixRegIntentService.class);
            startService(itent);
        }
    }
    ...
    protected void checkCustomerRegistration() {
//        if (BuildConfig.MOCKUP_APP != true)
//        {
//            if (WarrantixPreference.warrantixConfig.hasMainDevice() == false) {
//
//                CustomerRegistrationDialog dialog = new CustomerRegistrationDialog(MainActivity.this);
//                dialog.setOkButtonListener(btnOkClickListener);
//                dialog.show();
//            }
//            else {
//                BackendManager.getInstance().customerSignin();
//            }
//        }
    }
    ...
    public void changeStatusBarColor() {
        ...
        window.setStatusBarColor(getResources().getColor(R.color.wx_accent_color));
    }
...
//        WarrantixWebService.getInstance().getPluginMap();
    ...
    public void loadWalletModeFrom() {
...
//        }
    ...
    public void loadMarketplaceModeFrom() {
//        if  (selectedMarketIndex == -1) {
...
//                Toast.makeText(WarrantixApplication.getAppContext(), "ToMarket = " + brandName, Toast.LENGTH_SHORT).show();
    ...
    private final View.OnClickListener maskView1ClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
...
//        selectedMarketIndex = 0;
    ...
    public void showLoadingBar() {
        ...
        progressBar.getIndeterminateDrawable().setColorFilter(getResources().getColor(R.color.wx_primary_color), PorterDuff.Mode.SRC_IN);
//        progressBar.getProgressDrawable().setColorFilter(getResources().getColor(R.color.wx_accent_color), PorterDuff.Mode.SRC_IN);
        progressBar.setVisibility(View.VISIBLE);

        View maskView = (View) findViewById(R.id.maskView);
        maskView.setVisibility(View.VISIBLE);
        maskView.setOnClickListener(maskView1ClickListener);
    }
    ...
    private final CustomerRegistrationDialog.OkButtonListener btnOkClickListener = new CustomerRegistrationDialog.OkButtonListener() {
        @Override
        public void callback(String customerName, String mobileNumber, String eMail, String password) {
//            Toast.makeText(MainActivity.this, "Customer Registration is called", Toast.LENGTH_SHORT).show();
            BackendManager.getInstance().customerSignup(customerName, mobileNumber, eMail, password);
        }
    };
