...
import com.warrantix.main.fragments.walletbrand.WalletBrandAMCFragment1;
import com.warrantix.main.fragments.walletbrand.WalletBrandAMCFragment2;
import com.warrantix.main.fragments.walletbrand.WalletBrandAMCFragment3;

public class WalletBrandAMC extends BaseActivity implements View.OnClickListener {
    ...
    private final FragmentStatePagerAdapter contentPageAdapter = new FragmentStatePagerAdapter(getSupportFragmentManager()) {
        ...
        public Fragment getItem(int position) {
            if (position == 0)
                return new WalletBrandAMCFragment1();
            else if (position == 1)
                return new WalletBrandAMCFragment2();
            else if (position == 2)
                return new WalletBrandAMCFragment3();
            else
                return new Fragment();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brand_amc);
    }
