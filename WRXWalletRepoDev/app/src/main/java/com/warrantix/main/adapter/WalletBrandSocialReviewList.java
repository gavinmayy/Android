...
public class WalletBrandSocialReviewList extends ArrayAdapter<String> {

    private final Activity context;
    private final String[] name,address,days,explain;
    private final String[] imageId;

    public WalletBrandSocialReviewList(Activity context, String[] name, String[] address, String[] days, String[] explain,  String[] imageId) {
        super(context, R.layout.listview_wallet_brand_social_review, name);
