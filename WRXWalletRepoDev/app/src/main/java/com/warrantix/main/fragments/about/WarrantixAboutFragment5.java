...
public class WarrantixAboutFragment5 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tutorial5 = (ImageView) v.findViewById(R.id.tutorial5);
    ...
    public void animStart() {
        if (tutorial5 != null) {
            AnimationDrawable drawable = (AnimationDrawable) tutorial5.getBackground();
            tutorial5.setVisibility(View.VISIBLE);
            drawable.stop();
            drawable.start();

            // imageview 1
            AnimationSet animSet1 = createMoveAnimation(imageView1, 900 - 200);
            imageView1.startAnimation(animSet1);

            AnimationSet animSet2 = createMoveAnimation(imageView2, 900 - 200);
            imageView2.startAnimation(animSet2);

            AnimationSet animSet3 = createMoveAnimation(imageView3, 900 - 200);
            imageView3.startAnimation(animSet3);

            AnimationSet animSet4 = createMoveAnimation(imageView4, 900 - 200);
            imageView4.startAnimation(animSet4);

            AnimationSet animSet5 = createMoveAnimation(imageView5, 900 - 200);
            imageView5.startAnimation(animSet5);

            AnimationSet animTut1 = createMoveAnimation(tutorialm1, 800 - 200);
            tutorialm1.startAnimation(animTut1);

            AnimationSet animTut2 = createMoveAnimation(tutorialm2, 825 - 200);
            tutorialm2.startAnimation(animTut2);

            AnimationSet animTut3 = createMoveAnimation(tutorialm3, 850 - 200);
            tutorialm3.startAnimation(animTut3);

            AnimationSet animTut4 = createMoveAnimation(tutorialm4, 875 - 200);
            tutorialm4.startAnimation(animTut4);

            AnimationSet animTut5 = createMoveAnimation(tutorialm5, 900 - 200);
            tutorialm5.startAnimation(animTut5);

            AnimationSet animTut6 = createMoveAnimation(tutorialm6, 850 - 200);
