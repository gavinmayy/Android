...
public class WarrantixMarketplaceInsuranceAdapter extends ArrayAdapter<String> {
    ...
    public WarrantixMarketplaceInsuranceAdapter(Activity context, String[] name, String[] name0, String[] name1, String[] days, String[] imageId) {
        super(context, R.layout.listview_marketplace_insurance, name);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        serviceBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //...
                Intent mIntent = new Intent(getContext(),WalletBrandInsurance0.class);
